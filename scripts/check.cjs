...
const html=fs.readFileSync(path.join(root,'index.html'),'utf8');const version=sw.match(/gama-music-shell-v(\d+)/)[1];if(!html.includes(`src="./js/app.js?v=${version}"`)||!html.includes('type="module"'))error('entry module/cache version mismatch');
